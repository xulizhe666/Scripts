...
let retry = $.getval('Helge_0x001.Netflix_Retry') === 'true'
...
;(async () => {
  ...
  $.setval(JSON.stringify(fullAvailablePolicies), 'Helge_0x001.Netflix_Full_Available_Policies')
  $.setval(JSON.stringify(originalAvailablePolicies), 'Helge_0x001.Netflix_Original_Available_Policies')
})()
  .catch(error => {
    console.log(error)
