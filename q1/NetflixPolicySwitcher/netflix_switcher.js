...
let policyName = $.getval('Helge_0x001.Netflix_Policy') || 'Netflix'
let debug = $.getval('Helge_0x001.Netflix_Debug') === 'true'
let recheck = $.getval('Helge_0x001.Netflix_Recheck') === 'true'
let t = parseInt($.getval('Helge_0x001.Netflix_Timeout')) || 8000
let sortByTime = $.getval('Helge_0x001.Netflix_Sort_By_Time') === 'true'
let concurrency = parseInt($.getval('Helge_0x001.Netflix_Concurrency')) || 10
...
;(async () => {
  ...
  if (!isValidPolicy(policies[policyName])) {
    ...
    $.setval(policyName, 'Helge_0x001.Netflix_Policy')
  }
  ...
  try {
    cacheFullPolicies = JSON.parse($.getval('Helge_0x001.Netflix_Full_Available_Policies') ?? '[]')
  } catch (error) {
  ...
  try {
    cacheOriginalPolicies = JSON.parse($.getval('Helge_0x001.Netflix_Original_Available_Policies') ?? '[]')
  } catch (error) {
  ...
  $.setval(JSON.stringify(cacheFullPolicies), 'Helge_0x001.Netflix_Full_Available_Policies')
  $.setval(JSON.stringify(cacheOriginalPolicies), 'Helge_0x001.Netflix_Original_Available_Policies')
